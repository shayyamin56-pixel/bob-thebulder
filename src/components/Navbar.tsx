...
import { Menu, X, HardHat, LayoutDashboard } from "lucide-react";
      ...
      {isOpen && (
        <div className="md:hidden bg-primary-foreground text-primary p-4 flex flex-col gap-3 border-t">
          ...
          <Link to="/dashboard" onClick={() => setIsOpen(false)}>
            <Button variant="default" size="sm" className="w-full mt-2 flex items-center justify-center gap-1.5 font-bold">
              <LayoutDashboard className="h-4 w-4" />
              מערכת CRM
            </Button>
          </Link>
