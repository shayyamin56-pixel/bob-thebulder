    ...
    <main>
      ...
      <section className="bg-primary text-primary-foreground py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-rubik font-black mb-4">אודות בוב הבנאי</h1>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-rubik font-bold text-primary mb-6">הסיפור שלנו</h2>
              ...
              <Card key={v.title} className="hover:shadow-lg transition-shadow border-r-4 border-r-secondary">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-rubik font-bold text-lg text-primary mb-1">{v.title}</h3>
      ...
      <section className="py-16 bg-secondary">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-rubik font-bold text-secondary-foreground mb-4">
            רוצים לשמוע עוד?
          </h2>
